...
export default function DeletePages() {
  ...
  return (
    <>
    <SEO title={t('seo.deletePages.title', 'Delete Pages from PDF Online Free - Fast')} description={t('seo.deletePages.desc', 'Remove unwanted pages from your PDF document online. Delete specific pages instantly - no sign-up required, 100% free.')} keywords={[ t('seo.deletePages.keywords', 'delete PDF pages, remove PDF pages, delete pages from PDF, PDF page remover, delete unwanted pages from a PDF, remove pages from a PDF by number, remove blank pages from a PDF, best way to delete PDF pages, free online PDF editor, remove specific PDF pages, delete pages by number, clear pages from PDF, remove pages from PDF online'), ...generateLongTailKeywords(120), ...generateGeoKeywords(120) ].join(', ')} canonical="/delete-pages" />
