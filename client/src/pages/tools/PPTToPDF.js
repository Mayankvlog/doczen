...
export default function PPTToPDF() {
  ...
  return (
    <>
    <SEO title={t('tool.pptToPdfTitle', 'PPT to PDF Converter - Free Online Tool')} description={t('tool.pptToPdfDesc', 'Convert PowerPoint presentations to PDF format online. PPT to PDF in seconds - no sign-up required, 100% free.')} keywords={[ t('tool.pptToPdfKeywords', 'PPT to PDF, convert PowerPoint to PDF, PPTX to PDF, presentation to PDF, slide to PDF, convert PowerPoint slides to PDF, convert a PowerPoint to a PDF, best way to convert PowerPoint to PDF, free online PDF editor, PowerPoint to PDF converter, PPT to PDF online, presentation to PDF format, slides to PDF free'), ...generateLongTailKeywords(120), ...generateGeoKeywords(120), ...generateGhostKeywords(120) ].join(', ')} canonical="/ppt-to-pdf" />
