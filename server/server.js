...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'self' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://www.highperformanceformat.com https://zoologyfibre.com https://workdeadlinededicate.com https://kettledroopingcontinuation.com; connect-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://www.highperformanceformat.com https://protrafficinspector.com https://zoologyfibre.com https://workdeadlinededicate.com https://kettledroopingcontinuation.com; frame-src 'self' https://www.highperformanceformat.com https://zoologyfibre.com https://workdeadlinededicate.com https://kettledroopingcontinuation.com; img-src 'self' data: blob: https:; style-src 'self' 'unsafe-inline' https:; font-src 'self' data: https:; object-src 'none'; base-uri 'self'; form-action 'self';");
  next();
});
