...
export default function AddWatermark() {
  ...
  return (
    <>
    <SEO title={t('seo.addWatermarkTitle', 'Add Watermark to PDF Free - Online Tool')} description={t('seo.addWatermarkDesc', 'Add text watermarks to PDF files online. Protect documents with custom watermarks instantly. No sign-up required, 100% free.')} keywords={t('tool.addWatermarkKeywords', 'PDF watermark, add watermark to PDF, watermark PDF, text watermark, PDF protection')} canonical="/add-watermark" />
