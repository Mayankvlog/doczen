...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'self' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://www.highperformanceformat.com https://zoologyfibre.com https://workdeadlinededicate.com; style-src 'self' 'unsafe-inline' https:; font-src 'self' data: https:; img-src 'self' data: https:; connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://www.highperformanceformat.com https://zoologyfibre.com https://workdeadlinededicate.com https://protrafficinspector.com; frame-src 'self' https://www.highperformanceformat.com https://zoologyfibre.com https://workdeadlinededicate.com; object-src 'none'; base-uri 'self'; form-action 'self';");
  next();
});
