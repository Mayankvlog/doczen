...
app.use((req, res, next) => {
  ...
  res.setHeader('Strict-Transport-Security', 'max-age=31536000; includeSubDomains');
   res.setHeader('Content-Security-Policy', "default-src 'self' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://www.highperformanceformat.com https://workdeadlinededicate.com https://protrafficinspector.com https://realizationnewestfangs.com https://zoologyfibre.com https://spendsdetachment.com; connect-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://doczen.co.in https://www.doczen.co.in https://www.highperformanceformat.com https://protrafficinspector.com https://workdeadlinededicate.com https://realizationnewestfangs.com https://zoologyfibre.com https://spendsdetachment.com; frame-src 'self' https://www.highperformanceformat.com https://workdeadlinededicate.com https://realizationnewestfangs.com https://zoologyfibre.com https://spendsdetachment.com; img-src 'self' data: blob: https:; style-src 'self' 'unsafe-inline' https:; font-src 'self' data: https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self';");
  next();
});
